...
--Q.1 Write a SQL query to retrieve all columns for sales made on 2022-11-95
...
the 'Beauty' category.
--Q.5 Write a sql query to find all transactions where the total_sale is 
greater than 1000
--Q.6 Write a sql query to find the total number of [(transaction_id)]
...
total sales
--Q.9 Write a sql query to find the numbe of unique customers who purchased
...
## 📌 Project Overview
This project demonstrates SQL-based data analysis using a retail sales dataset. The objective is to explore sales performance, analyze customer purchasing behavior, and generate business insights using PostgreSQL.
...
## 📂 Dataset
The dataset contains retail sales transaction records with information such as:
- Transaction ID
- Sale Date
- Customer ID
- Category
...
- Explored monthly sales performance.
...
### Connect with me
- GitHub: https://github.com/devadathanpkishor
